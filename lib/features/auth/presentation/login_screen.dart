      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 22),
            // Sign In + biometric icon side by side. Login button takes the
            // remaining width; biometric button is a fixed circle.
            Row(
              children: [
                Expanded(
                  child: SizedBox(
                ...
                _BiometricButton(onTap: () => AppAlerts.info(context, 'Biometric sign-in coming in Phase 3')),
              ],
            ),
            const SizedBox(height: 14),
            Center(
